...
const {auctionMonthly, changes} = require('../models');
const ftp = require('../utils/ftp');
const auctionMonthlyImport = require('../utils/scripts/source/auctions-monthly');
...
module.exports = 
{
    ...
    {   
        ...
        try
        {
            result = await auctionMonthly.create
            (
                {
    ...
    async list(req, res)
    {
        ...
        try
        {
            result = await auctionMonthly.findAll();
