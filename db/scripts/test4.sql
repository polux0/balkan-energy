/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     6/23/2019 6:33:11 PM        
   IMPORTANT NOTE: DEFAULT '0' for automatically inserted data,
                   '1' for manually inserted data                 */
/*==============================================================*/
...
(
   AUCTIONYEARLYID3     int not null AUTO_INCREMENT,
   ...
   AUTOMATICALLYUPDATED int DEFAULT '0',
...
(
   AUCTIONYEARLYID2     int not null AUTO_INCREMENT,
   AUCTIONDAILYCODE     varchar(32),
   AUCTIONDAILYDISPLAY  varchar(32),
   AUCTIONDAILYTIME     timestamp,
   AUCTIONDAILYVALUE    decimal(10,3),
...
(
   AUCTIONYEARLYID      int not null AUTO_INCREMENT,
   AUCTIONDAILYCODE     varchar(32),
   AUCTIONDAILYDISPLAY  varchar(32),
   AUCTIONDAILYTIME     timestamp,
   AUCTIONDAILYVALUE    decimal(10,3),
...
(
   COMMERCIALFLOWID     int not null AUTO_INCREMENT,
...
(
   COMMERCIALFLOWID2    int not null AUTO_INCREMENT,
   PHYSICALFLOWCODE     varchar(32),
   PHYSICALFLOWDISPLAY  varchar(32),
   PHYSICALFLOWMEASURE  varchar(32),
   PHYSICALFLOWTIME     timestamp,
